...
def main():
    ...
    parser.add_argument('--swap_prob', type=float, default=0.0, help="Swap move probability (useful for objective=prefix)")
    ...
    parser.add_argument("--compact_prob", type=float, default=0.0, help="Compact move probability (boundary -> center).")
    ...
    parser.add_argument("--compact_square_prob", type=float, default=0.75, help="Fraction of compact moves that are axis-aligned.")
    parser.add_argument("--teleport_prob", type=float, default=0.0, help="Teleport move probability (boundary -> interior pocket).")
    parser.add_argument("--teleport_prob_end", type=float, default=-1.0, help="Final teleport prob (-1 keeps constant).")
    parser.add_argument("--teleport_tries", type=int, default=4, help="Teleport: candidate tries per step.")
    parser.add_argument("--teleport_anchor_beta", type=float, default=6.0, help="Teleport: bias toward center anchors (higher=more central).")
    parser.add_argument("--teleport_ring_mult", type=float, default=1.02, help="Teleport: radius multiplier around anchor.")
    parser.add_argument("--teleport_jitter", type=float, default=0.05, help="Teleport: random XY jitter (in radius units).")
